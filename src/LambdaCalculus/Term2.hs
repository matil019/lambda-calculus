...
module LambdaCalculus.Term2 where
...
import qualified LambdaCalculus.Term.Types as Term1
...
fromTerm1 :: Term1.Term -> Term
fromTerm1 (Term1.Var x) = Var x
fromTerm1 (Term1.Abs x m) = Abs x (fromTerm1 m)
fromTerm1 (Term1.App m n) = App (fromTerm1 m) (fromTerm1 n)
